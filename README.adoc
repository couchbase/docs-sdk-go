...
This repository hosts the documentation source for the https://docs.couchbase.com/go-sdk/2.13/hello-world/overview.html[Couchbase Go SDK].

This branch documents the 2.12 release of the SDK.
It follows the https://docs.couchbase.com/go-sdk/2.13/project-docs/compatibility.html#api-version[SDK 3.10 API].
...
The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/go-sdk/2.13/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
...
* modules/devguide/examples/go/student-record/go.mod
* modules/devguide/examples/go/student-record/sum
