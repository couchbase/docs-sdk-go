image:https://github.com/couchbase/docs-sdk-go/actions/workflows/build.yml/badge.svg?branch=release%2F2.2[link="https://github.com/couchbase/docs-sdk-go/actions/workflows/build.yml"] 
