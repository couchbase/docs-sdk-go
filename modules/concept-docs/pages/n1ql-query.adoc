...
NOTE: In the Go SDK the `adhoc` parameter is `Adhoc`.
...
----
include::devguide:example$go/n1ql-query_test.go[tag=prepared-statement]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query_test.go[tag=create-index]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query_test.go[tag=deferred-index]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query_test.go[tag=index-consistency]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query_test.go[tag=index-consistency-request-plus]
----
