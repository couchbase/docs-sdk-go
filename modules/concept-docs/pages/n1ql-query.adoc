...
----
include::devguide:example$go/n1ql-query.go[tag=prepared-statement]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query.go[tag=create-index]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query.go[tag=deferred-index]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query.go[tag=index-consistency]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query.go[tag=index-consistency-request-plus]
----
