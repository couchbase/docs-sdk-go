...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=configExpiration,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=fullErrorHandling,indent=0]
----
