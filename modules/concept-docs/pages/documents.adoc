...
[source,golang,indent=0]
----
include::devguide:example$go/documents_test.go[tag=mutate-in]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/documents_test.go[tag=lookup-in]
----
...
[source,go,indent=0]
----
include::devguide:example$go/documents_test.go[tag=counters]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/documents_test.go[tag=counter-increment]
----
