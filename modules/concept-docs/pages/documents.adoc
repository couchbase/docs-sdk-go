...
[source,golang,indent=0]
----
include::devguide:example$go/documents.go[tag=mutate-in]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/documents.go[tag=lookup-in]
----
...
[source,go,indent=0]
----
include::devguide:example$go/documents.go[tag=counters]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/documents.go[tag=counter-increment]
----
