...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=init,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=create-simple,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=rollbackCause,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=customMetadata,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=customMetadataTxn,indent=0]
----
