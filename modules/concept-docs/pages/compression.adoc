...
you can disable compression by setting  `CompressionMode = "off"`.

This can be done in the xref:ref:client-settings.adoc[ConnectionOptions()], or in the xref:howtos:managing-connections.adoc#connection-strings[Connection String].
