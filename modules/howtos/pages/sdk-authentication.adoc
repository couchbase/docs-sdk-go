...
----
include::devguide:example$go/connecting_test.go[tag=simpleconnect]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/connecting-cca_test.go[tag=certconnect]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/connecting_test.go[tag=insecureLDAP]
----
