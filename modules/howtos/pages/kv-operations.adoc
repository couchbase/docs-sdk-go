...
The complete code sample used on this page can be downloaded from https://github.com/couchbase/docs-sdk-go/blob/release/2.1/modules/devguide/examples/go/kv-crud.go[here]
