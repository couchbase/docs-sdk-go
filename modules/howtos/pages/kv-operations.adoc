...
The complete code sample used on this page can be downloaded from https://github.com/couchbase/docs-sdk-go/blob/temp/{sdk_dot_minor}/modules/devguide/examples/go/kv-crud_test.go[here]
...
[source,go,indent=0]
----
include::devguide:example$go/kv-crud_test.go[tag=insert]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-crud_test.go[tag=insertoptions]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-expiry_test.go[tag=expiry]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-durability-enhanced_test.go[tag=durability]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-durability-observe_test.go[tag=observebased]
----
...
IMPORTANT: Preferred Server Group Replica Reads are only accessible with the {name-sdk} working with Couchbase Server 7.6.2 or newer (Capella or self-managed), from SDK version 2.9.3.
...
[source,go,indent=0]
----
include::devguide:example$go/kv-crud_test.go[tag=get]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-crud_test.go[tag=gettimeout]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-expiry_test.go[tag=touch]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-expiry_test.go[tag=getandtouch]
----
...
[source,go,indent=0]
----
include::devguide:example$go/kv-counter_test.go[tag=increment]
----

.Decrement
[source,go,indent=0]
----
include::devguide:example$go/kv-counter_test.go[tag=decrement]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan_test.go[tag=range_scan_all_documents, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan_test.go[tag=range_scan_prefix, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan_test.go[tag=range_scan_sample, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-range-scan_test.go[tag=range_scan_all_document_ids, indent=0]
----
...
[source,go]
----
include::devguide:example$go/kv-collection-scope_test.go[tag=namedcollectionupsert, indent=0]
----
