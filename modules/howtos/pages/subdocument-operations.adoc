...
IMPORTANT: The Sub-Document operations described on this page are for _Key-Value_ requests only: they are not related to Sub-Document xref:server:n1ql:n1ql-language-reference/subqueries.adoc#keyspace-identifier-versus-expression[{sqlpp}] queries.
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin_test.go[tag=lookupInGet, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin_test.go[tag=lookupInExists, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin_test.go[tag=lookupInMulti, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein_test.go[tag=mutateInUpsert, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein_test.go[tag=mutateInInsert, indent=0]
----

Dictionary values can also be replaced or removed, and you may combine any multiple Sub-Document operations --
these are formed into a single command packet, which is then executed atomically on the server.
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein_test.go[tag=mutateInMulti, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayAppend, indent=0]
----

.Array prepending a sub-document
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayPrepend, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayDoc, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayDocMulti, indent=0]
----

.Add single array as element to existing array
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayDocMultiSingle, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayAppendMulti, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayAppendCreatePath, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayAddUnique, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein-arrays_test.go[tag=mutateInArrayInsert, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-counter_test.go[tag=mutateInIncrement, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-counter_test.go[tag=mutateInDecrement, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-mutatein_test.go[tag=mutateInCreatePath, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin_test.go[tag=lookupInAnyReplica, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-lookupin_test.go[tag=lookupInAllReplicas, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc_test.go[tag=concurrent, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc_test.go[tag=cas, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-durability_test.go[tag=traddurability, indent=0]
----
...
[source,go]
----
include::devguide:example$go/subdoc-durability_test.go[tag=newdurability, indent=0]
----
