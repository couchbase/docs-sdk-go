...
NOTE: Connection to Couchbase Cloud requires Couchbase Go SDK 2.0 and up, unless you use a xref:1.6@go-sdk:ROOT:managing-connections.adoc#cloud-connections[workaround in 1.6].
