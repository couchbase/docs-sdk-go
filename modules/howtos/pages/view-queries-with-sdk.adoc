...
WARNING: Although still maintained and supported for legacy use, Views date from the earliest days of Couchbase Server development, and as such are rarely the best choice over, say, xref:n1ql-queries-with-sdk.adoc[our Query service] for your application, see xref:concept-docs:http-services.adoc[our guide to choosing the right service].
...
----
include::example$views.go[tag=beers]
----
...
[source,golang,indent=0]
----
include::example$views.go[tag=landmarks]
----
