...
----
include::devguide:example$go/concurrent-async_test.go[tag=connect]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/concurrent-async_test.go[tag=workers]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/concurrent-async_test.go[tag=loadData]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/concurrent-async_test.go[tag=wait]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/concurrent-batch_test.go[tag=loadData]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/concurrent-batch_test.go[tag=send]
----
...
The above example was for an `Upsert`, but the advice and techniques are the same for other CRUD operations.
Here is an example of a bulk get:

[source,golang,indent=0]
----
include::devguide:example$go/bulk_get.go[tag=bulk-get]
include::devguide:example$go/bulk_get.go[tag=send]
----
