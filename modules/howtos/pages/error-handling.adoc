...
----
include::example$errors.go[tag=as]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=is]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=replace]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=exists]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=cas]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=insert]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=insert-real]
----
...
[source,golang,indent=0]
----
include::example$errors.go[tag=query]
----
