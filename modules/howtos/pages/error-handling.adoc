...
----
include::devguide:example$go/error-handling_test.go[tag=is]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/error-handling_test.go[tag=replace]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/error-handling_test.go[tag=exists]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/error-handling_test.go[tag=cas]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/error-handling_test.go[tag=insert]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/error-handling_test.go[tag=insert-real]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/error-handling_test.go[tag=query]
----
