...
[source,go]
----
include::devguide:example$go/observability-tracing_test.go[tag=threshold-logging]
----
...
[source,go]
----
include::devguide:example$go/observability-tracing_test.go[tag=otel-tracing]
----
...
[source,go]
----
include::devguide:example$go/observability-tracing_test.go[tag=parent-span]
----
