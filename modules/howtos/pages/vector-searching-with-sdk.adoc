...
[source,go,indent=0]
----
include::devguide:example$go/n1ql-query-vector_test.go[tag=vector-hyperscale-index]
----
...
[source,go,indent=0]
----
include::devguide:example$go/n1ql-query-vector_test.go[tag=vector-hyperscale-index-parameterized]
----
