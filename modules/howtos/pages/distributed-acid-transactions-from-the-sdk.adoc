...
:reftext: Distributed ACID Transactions from the Go SDK
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=examples,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=insert,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=get,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=getOpt,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=getReadOwnWrites,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=replace,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=remove,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=querySelectScope,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=queryUpdate,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=queryComplex,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=queryInsert,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=queryOptions,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=queryRyow,indent=0]
----
...
[source,go]
----
include::devguide:example$go/transactions_test.go[tag=config,indent=0]
----
