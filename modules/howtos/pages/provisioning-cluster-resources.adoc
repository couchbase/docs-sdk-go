...
----
include::devguide:example$go/provisioning-resources-buckets_test.go[tag=creatingbucketmgr]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-buckets_test.go[tag=createBucket]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-buckets_test.go[tag=updateBucket]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-buckets_test.go[tag=removeBucket]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-buckets_test.go[tag=flushBucket]
----
...
[source,golang]
----
include::devguide:example$go/collection-manager_test.go[tag=create-collection-manager,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager_test.go[tag=create-scope,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager_test.go[tag=create-collection,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager_test.go[tag=drop-collection,indent=0]

include::devguide:example$go/collection-manager_test.go[tag=drop-scope,indent=0]
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager_test.go[tag=scopeAdmin, indent=0]
...
[source,golang]
----
include::devguide:example$go/query-index-manager_test.go[tag=creating-index-mgr,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager_test.go[tag=primary,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager_test.go[tag=secondary,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager_test.go[tag=defer-indexes,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager_test.go[tag=drop-primary-or-secondary-index,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-views_test.go[tag=viewmgr]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-views_test.go[tag=createView]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-views_test.go[tag=getView]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-views_test.go[tag=publishView]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/provisioning-resources-views_test.go[tag=removeView]
----
