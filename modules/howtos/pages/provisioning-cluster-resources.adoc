...
[source,golang]
----
include::devguide:example$go/collection-manager.go[tag=create-collection-manager,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager.go[tag=create-scope,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager.go[tag=create-collection,indent=0]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager.go[tag=drop-collection,indent=0]

include::devguide:example$go/collection-manager.go[tag=drop-scope,indent=0]
...
[source,golang,indent=0]
----
include::devguide:example$go/collection-manager.go[tag=scopeAdmin, indent=0]
...
[source,golang]
----
include::devguide:example$go/query-index-manager.go[tag=creating-index-mgr,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager.go[tag=primary,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager.go[tag=secondary,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager.go[tag=defer-indexes,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/query-index-manager.go[tag=drop-primary-or-secondary-index,indent=0]
----
