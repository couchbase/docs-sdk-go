...
----
include::example$provisioningresources.go[tag=creatingbucketmgr]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=createBucket]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=updateBucket]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=removeBucket]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=flushBucket]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=viewmgr]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=createView]
----
...
This parameter specifies whether the design document should be created as development, or as production --with the former running over only a smallfraction of the documents.

Now that we've created a design document we can fetch it:

[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=getView]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=publishView]
----
...
[source,golang,indent=0]
----
include::example$provisioningresources.go[tag=removeView]
----
