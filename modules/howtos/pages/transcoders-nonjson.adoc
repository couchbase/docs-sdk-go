...
----
include::devguide:example$go/transcoding-rawjson_test.go[tag=rawjsonmarshal]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/transcoding-rawjson_test.go[tag=rawjsonunmarshal]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/transcoding-rawstring_test.go[tag=rawstring]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/transcoding-rawbinary_test.go[tag=rawbinary]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/transcoding-custom_test.go[tag=msgpack]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/transcoding-custom_test.go[tag=msgpack-transcode]
----
