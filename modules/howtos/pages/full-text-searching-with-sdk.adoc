...
We will perform a Search query here -- see the <<vector-search>> section for Vector Search examples.
Here is a simple `MatchQuery` that looks for the text 'swanky' using a defined index:

[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=matchquery]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=daterangequery]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=conjunctionquery]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=iteratingrows]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=iteratingfacets]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=single_vector_query]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=multiple_vector_queries]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=vector_fts_query_combination]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=fts_search_request]
----
...
[source,go,indent=0]
----
include::devguide:example$go/search_test.go[tag=consistency]
----
