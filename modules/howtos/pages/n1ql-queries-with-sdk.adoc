...
----
include::example$query.go[tag=pos-params]
----
...
[source,golang,indent=0]
----
include::example$query.go[tag=named-params]
----
...
[source,golang,indent=0]
----
include::example$query.go[tag=results]
----
...
[source,golang,indent=0]
----
include::example$query.go[tag=consistency]
----
