...
:page-toclevels: 2
:page-aliases: n1ql-query.adoc,ROOT:querying.adoc,n1ql-queries-with-sdk.adoc
...
----
include::devguide:example$go/query_test.go[tag=simple]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-named-placeholders_test.go[tag=named-params]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-positional-placeholders_test.go[tag=pos-params]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-simple_test.go[tag=results]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-one_test.go[tag=one]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-metrics_test.go[tag=metrics]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-consistency_test.go[tag=consistency]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/n1ql-query-consistentwith_test.go[tag=consistentwith]
----
////
...
It is possible to query off the xref:{version-server}@server:learn:data/scopes-and-collections.adoc[`Scope` level] with _Couchbase Server release 7.0_ onwards,
...
[source,golang,indent=0]
----
include::devguide:example$go/query_test.go[tag=simple-named-scope]
----
