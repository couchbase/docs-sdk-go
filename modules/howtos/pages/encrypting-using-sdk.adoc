...
----
include::devguide:example$go/fle_test.go[tag=keys]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/fle_test.go[tag=provider]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/fle_test.go[tag=transcoder]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/fle_test.go[tag=annotation]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/fle_test.go[tag=upsert]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/fle_test.go[tag=getmap]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/fle_test.go[tag=getstr]
----
...
SDK 1.x reached end-of-life long ago,
but should you have fields encrypted by SDK 1.x, and the need to read them from SDK 2.x, 
then follow the steps in the https://docs-archive.couchbase.com/go-sdk/2.6/howtos/encrypting-using-sdk.html#migration-from-sdk1[archived documents].


IMPORTANT: The encryption algorithms used by SDK 1 are deprecated, and are no longer used for encrypting new data.
