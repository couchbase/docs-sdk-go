...
NOTE: The encryption code is packaged as an optional library because it is released under a https://github.com/couchbase/gocbencryption/blob/master/LICENSE[different license^] than the Couchbase Go SDK.
