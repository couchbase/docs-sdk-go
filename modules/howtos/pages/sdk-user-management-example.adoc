...
----
include::devguide:example$go/user-management_test.go[tag=upsert]
----

.Listing Users
[source,golang,indent=0]
----
include::devguide:example$go/user-management_test.go[tag=getall]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/user-management_test.go[tag=operations]
----
...
[source,golang]
----
include::devguide:example$go/change-password_test.go[tag=change-password]
----
