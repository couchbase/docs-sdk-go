...
----
include::devguide:example$go/analytics_test.go[tag=query]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics-simple-query_test.go[tag=simple]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics-positional-placeholders_test.go[tag=positional]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics-named-placeholders_test.go[tag=named]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics_test.go[tag=options]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics-simple-query_test.go[tag=results]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics-query-one_test.go[tag=one]
----
...
[source,golang,indent=0]
----
include::devguide:example$go/analytics-simple-query_test.go[tag=metadata]
----
...
[source,golang]
----
include::devguide:example$go/analytics-collection-scope_test.go[tag=handle-collection,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/analytics-collection-scope_test.go[tag=handle-scope,indent=0]
----
