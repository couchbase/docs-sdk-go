...
Improvements to Query error handling. Added handling for some additional query error codes.
* https://issues.couchbase.com/browse/GOCBC-1549[GOCBC-1549]:
Add the ability to specify both positional and named parameters in queries.
...
Display the error description from the KV error map when an unknown KV status is received.
