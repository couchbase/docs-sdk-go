...
Version 2.2.0 is the first maintenance release for the Go SDK 2.2.0.
...
Update search `GeoPolygon` support to API stability committed.
* https://issues.couchbase.com/browse/GOCBC-1015[GOCBC-1015]:
Update `QueryOptions` `FlexIndex` support to API stability committed.
* https://issues.couchbase.com/browse/GOCBC-1026[GOCBC-1026]:
Update `BucketSettings` ephemeral eviction policies support to API stability committed.
