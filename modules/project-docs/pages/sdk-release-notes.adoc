...
[source,console]
----
$ go get github.com/couchbase/gocb/v2@v2.3.4
----
...
Added the ResponseBody field to QueryError and N1qlError, to allow easier debugging and error handling.
...
This fixed an issue with stuck deployments after upgrade to server 7.0.2.
