...
* https://jira.issues.couchbase.com/browse/GOCBC-1815[GOCBC-1815]: Include more information in the warning-level log message when snappy decoding fails for a KV response.
