...
[source,console]
----
$ go get github.com/couchbase/gocb/v2@v2.5.2
----
...
Version 2.5.2 is a maintenance release for the Go SDK 2.5.0.
...
Version 2.5.1 is a maintenance release for the Go SDK 2.5.0.
