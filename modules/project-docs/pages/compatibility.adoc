...
At time of writing (October 2022), this is 1.18 and 1.19.
...
At time of writing (October 2022): 13 (_Ventura_), 12 (_Monterey_), and 11 (_Big Sur_).
M1 ARM  architecture is fully supported in the 2.6 Go SDK.
****
...
| Protostellar connection protocol
2+| Not Supported
| With xref:operator::overview.adoc[Couchbase Autonomous Operator] 2.6+
|===
