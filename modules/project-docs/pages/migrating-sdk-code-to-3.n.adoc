...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=getresult,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=queryresult,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=basicconnecting,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=passauthenticator,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=certauthenticator,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=getcollection,indent=0]
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=handleerror,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating.go[tag=handleerrorext,indent=0]
----
