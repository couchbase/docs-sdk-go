...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=getresult,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=queryresult,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=basicconnecting,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=passauthenticator,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=certauthenticator,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=getcollection,indent=0]
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=handleerror,indent=0]
----
...
[source,golang]
----
include::devguide:example$go/migrating_test.go[tag=handleerrorext,indent=0]
----
