...
====
Couchbase's large number of ports across the URLs of many services can be proxied by using the `couchbase2://` protocol in the connection string -- read more on the xref:howtos:managing-connections.adoc#protostellar[Connections] page.
====
