...
[source,bash]
----
$ go get github.com/couchbase/gocb/v2@v2.0.0
----
...
// The API reference is generated for each release and can be foundhttps://pkg.go.dev/github.com/couchbase/gocb/v2[here].
