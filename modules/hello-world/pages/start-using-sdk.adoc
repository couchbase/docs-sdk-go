...
Now you have the Go client installedopen your favourite text editor and try out the following:
...
Here weve used the `DefaultCollection`, which covers the whole Bucket.
