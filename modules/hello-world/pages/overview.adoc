...
[source,golang]
----
include::devguide:example$go/n1ql-query-consistency_test.go[tag=consistency,indent=0]
----
--
...
[source,golang]
----
include::devguide:example$go/search_test.go[tag=vector_fts_query_combination,indent=0]
----
--
====
...
[source,go]
----
include::devguide:example$go/overview_test.go[tag=overview,indent=0]
----
