...
Connecting to  couchbase Cloud requires TLS and DNs-SRV, as detailed above.
Additionally, if you are using a xref:cloud:clouds:private-network.adoc[private network], for Go SDK 1.6.x you will need to set `network=default` in the connection string.
